...
public class AverageSessionDurationTest {
    AverageSessionDuration analyzer = new AverageSessionDuration();

    @Test
    void apply_withThreeSessions_returnAverageDuration() {
        ...
        assertEquals(Long.valueOf(595), result.getResult());
